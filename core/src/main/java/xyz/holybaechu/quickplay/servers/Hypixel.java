...
public class Hypixel {
    ...
    public Hypixel(){
        ...
        minigames.add(new HypixelMinigame().setName("Blitz Survival Games").setModes(Map.ofEntries(
        ...
        minigames.add(new HypixelMinigame().setName("Skywars").setModes(Map.ofEntries(
                ...
                Map.entry("Mega Normal", "mega_normal"),
                Map.entry("Mega Teams", "mega_doubles"),
                Map.entry("Ranked", "ranked_normal"),
                Map.entry("Solo TNT Madness", "solo_insane_tnt_madness"),
                Map.entry("Teams TNT Madness", "teams_insane_tnt_madness"),
                Map.entry("Solo Rush", "solo_insane_rush"),
                Map.entry("Teams Rush", "teams_insane_rush"),
                Map.entry("Solo Slime", "solo_insane_slime"),
                Map.entry("Teams Slime", "teams_insane_slime"),
                Map.entry("Solo Lucky Blocks", "solo_insane_lucky"),
                Map.entry("Teams Lucky Blocks", "teams_insane_lucky"),
        ...
        minigames.add(new HypixelMinigame().setName("TNT Games").setModes(Map.ofEntries(
                ...
                Map.entry("Bowspleef", "tnt_bowspleef"),
        ...
        minigames.add(new HypixelMinigame().setName("Bed Wars").setModes(Map.ofEntries(
                ...
                Map.entry("Rush 4v4", "bedwars_four_four_rush"),
                Map.entry("Ultimate Doubles", "bedwars_eight_two_ultimate"),
                Map.entry("Ultimate 4v4", "bedwars_four_four_ultimate"),
                Map.entry("Castles", "bedwars_castle"),
        ...
        minigames.add(new HypixelMinigame().setName("Arcade").setModes(Map.ofEntries(
                ...
                Map.entry("Hide and Seek - Prot Hunt", "arcade_hide_and_seek_prop_hunt"),
                ...
                Map.entry("Pixel Party", "arcade_pixel_party") // Pixel Party is not on the wiki (I don't know why)
        )));
        ...
        minigames.add(new HypixelMinigame().setName("Duels").setModes(Map.ofEntries(
                Map.entry("Solo Classic", "duels_classic_duel"),
                Map.entry("Solo SkyWars", "duels_sw_duel"),
                Map.entry("Doubles SkyWars", "duels_sw_doubles"),
                Map.entry("Solo Bow", "duels_bow_duel"),
                Map.entry("Solo UHC", "duels_uhc_duel"),
                Map.entry("Doubles UHC", "duels_uhc_doubles"),
                Map.entry("Teams UHC (4v4)", "duels_uhc_four"),
                Map.entry("Deathmatch UHC", "duels_uhc_meetup"),
                Map.entry("Solo NoDebuffs", "duels_potion_duel"),
                Map.entry("Solo Combo", "duels_combo_duel"),
                Map.entry("Solo Potion", "duels_potion_duel"),
                Map.entry("Solo OP", "duels_op_duel"),
                Map.entry("Doubles OP", "duels_op_doubles"),
                Map.entry("Solo Mega Walls", "duels_mw_duel"),
                Map.entry("Doubles Mega Walls", "duels_mw_doubles"),
                Map.entry("Solo Sumo", "duels_sumo_duel"),
                Map.entry("Solo Blitz", "duels_blitz_duel"),
                Map.entry("Solo Bow Spleef", "duels_bowspleef_duel"),
                Map.entry("Bridge 1v1", "duels_bridge_duel"),
                Map.entry("Bridge 2v2", "duels_bridge_doubles"),
        ...
        minigames.add(new HypixelMinigame().setName("Dropper").setModes(Map.ofEntries(Map.entry("Standard", "prototype_dropper"))));
    }
}
